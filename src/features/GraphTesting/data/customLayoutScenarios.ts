  ...
  23: {
    ...
    edges: [
      ...
      },
      {
        ...
        target: "WH",
        label:
          "idempotent upsert into the daily partition, deduplicated on the natural business key",
      },
      {
        source: "QUAR",
        target: "NORM",
