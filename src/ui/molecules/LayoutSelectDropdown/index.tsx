...
import { LAYOUT_MODE_DESCRIPTORS } from "./LayoutSelectDropdown.types";
...
const LAYOUT_ICONS: Record<LayoutMode, React.ReactNode> = {
  ...
  "layered-spline": (
    ...
    >
      <rect width="7" height="5" x="8.5" y="3" rx="1" />
      <path d="M12 8c0 3-6 1-6 4" />
      <rect width="6" height="5" x="3" y="14" rx="1" />
      <path d="M12 8c0 3 6 1 6 4" />
      <rect width="6" height="5" x="15" y="14" rx="1" />
    </svg>
  ),
  "left-right": (
    <svg
...
// Runtime exports (LAYOUT_MODE_DESCRIPTORS, describeLayoutMode) deliberately stay in
// ./LayoutSelectDropdown.types: re-exporting them here would make this a mixed module and cost
// React Fast Refresh for the dropdown.
export type { LayoutModeDescriptor, LayoutSelectDropdownProps } from "./LayoutSelectDropdown.types";
