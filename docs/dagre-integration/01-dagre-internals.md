...
> [!IMPORTANT]
> **This is Library Context.** GVUI never modifies the internal Dagre code. This document explains the underlying concepts so you understand *why* Dagre behaves the way it does, not to teach you how to maintain it.
