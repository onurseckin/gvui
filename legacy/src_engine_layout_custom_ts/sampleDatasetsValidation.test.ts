...
import type { GraphDataset, GraphNodeData } from "../../src/types/graphData";
...
describe("Public Sample Datasets Quality Gate Suite", () => {
  const datasets: TestDatasetItem[] = [
    ...
    {
      filename: "distributed_saga_workflow.json",
      dataset: distributedSagaWorkflow as unknown as GraphDataset,
    },
    {
      filename: "kubernetes_cluster_topology.json",
      dataset: kubernetesClusterTopology as unknown as GraphDataset,
    },
  ];
